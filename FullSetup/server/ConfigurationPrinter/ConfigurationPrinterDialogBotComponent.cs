...
public class ConfigurationPrinterDialogBotComponent : BotComponent
{
    /// <summary>
    ...
    public override void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<DeclarativeType>(sp => new DeclarativeType<ConfigurationPrinterDialog>(ConfigurationPrinterDialog.Kind));
    }
}
